...
public class Bottom_Sheft_Update_KhoaHoc extends BottomSheetDialogFragment {
    ...
    public Bottom_Sheft_Update_KhoaHoc() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottomm_sheft_update_khoahoc,container,false);
        ...
        final Bundle getdulieu = getArguments();
        String makh =getdulieu.getString("Makh");
        String tenkh =getdulieu.getString("Tenkh");
        double tien =getdulieu.getDouble("Tien");
        String ngay =getdulieu.getString("ngay");
        ...
        edt_makh.setText(makh);
        edt_tenkh.setText(tenkh);
        edt_tien.setText(String.valueOf(tien));
        tv_date.setText(ngay);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String idkh = getdulieu.getString("Idkh");
                datakhoahoc= new ArrayList<>();
                daokhoahoc = new DAOKHOAHOC(getContext());

                daokhoahoc.update(idkh,makh,tenkh,tien,ngay,imageViewToByte(imghinhshow));
